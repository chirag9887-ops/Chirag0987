...
bot = telebot.TeleBot('8630307432:AAHRnmiKjb3M7xirhCuKUq9OnzBcQkxVPpM')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "❌ Unauthorized! Only admin can use this command. Buy access: @ONEPLUSLOADERSELLER"
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🚀🚀\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: VIP - @ONEPLUSLOADERSELLER 🔥"
    bot.reply_to(message, response)
