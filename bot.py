...
# ===== CONFIGURATION =====
BOT_TOKEN = "8725760661:AAEtlu9QG8ifkRq4tfX6i8VvTBKFJ_hveSc"  # Change this!
ADMIN_IDS = [8445047405]  # Change to your Telegram ID
CHANNEL_USERNAME = "@NextDimdos"  # Your channel
...
def home():
    return '''
    <html>
    <head><title>NEXT TEAM BOT</title></head>
...
def handle_photo(message):
    ...
    bot.reply_to(
        message,
        f"✅ *Feedback Received!*\n\n"
        f"Thank you @{NEXT_2ND} for your support!\n"
        f"💪 Keep attacking with @NEXT_2ND!",
        parse_mode="Markdown"
    )

# ===== MAIN =====
if __name__ == "__main__":
    print("🔥 Starting NEXT TEAM DDOS BOT...")
